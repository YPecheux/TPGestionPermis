...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    // TODO add your handling code here
        ...
        else
        {
            ...
            else
            {
                ...
                //test
                Test t = new Test(gst.getTousLesTests().get(lstTests.getSelectedIndex()).getIdTest(),
                                  gst.getTousLesTests().get(lstTests.getSelectedIndex()).getNomTest(),0,false);
                }
            }          
        }      
        }
    ...
    private void btnModificationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificationActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "Choisir un test à modifier !");
        }
        else
        {
